...
├── requirements.txt        # Exact dependencies for pip install
├── pyproject.toml          # Project configuration and Python version
├── src/
│   └── app/
│       ├── __init__.py
│       ├── agent/          # Cloud based and Local based agent logic
